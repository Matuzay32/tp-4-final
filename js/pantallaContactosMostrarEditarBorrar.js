...
document
	.getElementById("botonDeBusqueda")
	.addEventListener("click", async (ev) => {
		ev.preventDefault();
		let cuerpoTablaContactoPantallaContactos = document.getElementById(
			"cuerpoTablaContactoPantallaContactos"
		);
		...
		setTimeout(async () => {
			...
			const datosFiltrados = datos.filter((e) => {
				return (
					e.compania.compania.toLowerCase() ==
						busquedaGeneral.value.toLowerCase() ||
					e.interes.toLowerCase() == busquedaGeneral.value.toLowerCase() ||
					e.ciudade.ciudad.toLowerCase() ==
						busquedaGeneral.value.toLowerCase() ||
					e.paise.pais.toLowerCase() ==
						busquedaGeneral.value.toLowerCase() ||
	...
	const response = await fetch("http://localhost:3000/api/contactos", {
		...
		headers: {
			...
			"user-token": ObtenerTokenLocalStorage(
				...
				"Intente ingresar a la sesion nuevamente para editar un contacto"
			),
		},
	...
	const response = await fetch("http://localhost:3000/api/contactos", {
		...
		headers: {
			...
			"user-token": ObtenerTokenLocalStorage(
				...
				"Intente ingresar a la sesion nuevamente para borrar un contacto"
...
var botonBorrarContacto = () => {
	let botonesBorrarContacto =
		document.getElementsByClassName("btnBorrarContacto");
...
var botonEditarContacto = () => {
	let botonesEditarContactos =
		document.getElementsByClassName("btnEditarContactos");
...
var botonExportarContacto = () => {
	let botonesExportarContactos =
		document.getElementsByClassName("btnExportar");
...
var ocultarNumeroYinstagram = () => {
	let botonesWhatsapp = document.getElementsByClassName(
		"btnWhatsappPantallaContactos"
	);
	let botonesInstagram = document.getElementsByClassName(
		"btnInstagramPantallaContactos"
	);
	let numerosWhatsapp = document.getElementsByClassName(
		"numeroWhatsappPantallaContactos"
	);
	let instagrams = document.getElementsByClassName(
		"instagramPantallaContactos"
	);
...
document
	.getElementById("contactosLink")
	.addEventListener("click", async function (params) {
		actulizarTabla();
	});
...
let resetearFormulario = () => {
	let editar_nombre = (document.getElementById(
		"nombreMenuNuevoContacto"
	).value = "");
	let editar_apellido = (document.getElementById(
		"apellidoMenuNuevoContacto"
	).value = "");
	...
	let editar_email = (document.getElementById("emailMenuNuevoContacto").value =
		"");
	let editar_direccion = (document.getElementById(
		"direccionMenuNuevoContacto"
	).value = "");
	let editar_interes = (document.getElementById(
		"rangeMenuNuevoContacto"
	).value = "");
	...
	let editar_datosCanal02 = (document.getElementById("datosCanal02").value =
		"");
	let editar_compania = (document.getElementById(
		"companiaNuevoContacto"
	).value = "");
	let editar_pais = (document.getElementById("paisMenuNuevoContacto").value =
		"");
	let editar_provincia = (document.getElementById(
		"provinciaMenuNuevoContacto"
	).value = "");
	let editar_ciudad = (document.getElementById(
		"ciudadMenuNuevoContacto"
	).value = "");
	let editar_canal = (document.getElementById("canalMenuNuevoContacto").value =
		"");
	let editar_canal2 = (document.getElementById(
		"canalMenuNuevoContacto2"
	).value = "");
};
...
let fetchContactosBusqueda = (
	...
	fetch(`http://localhost:3000/api/contactos/searchName?${interesBusqueda}`)
		...
		.then((data) => {
			//let muestra = contactoDatos(data);
			console.log(
				`http://localhost:3000/api/contactos/searchName?${interesBusqueda}`
			);
			console.log(data);
		});
};
